...
plt.savefig('Case5-Fig1.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(2)
plt.clf()
...
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.savefig('Case5-Fig2.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(3)
plt.clf()
plt.xlabel('Time (sec)', fontsize=25)
plt.ylabel('Angular velocity (degree/sec)', fontsize=25)
plt.xticks(fontsize=25)
plt.yticks(fontsize=25)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.savefig('Case5-Fig3.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(4)
plt.clf()
plt.xlabel('Time (sec)', fontsize=25)
plt.ylabel('Angular acceleration (degree/sec$^2$)', fontsize=25)
plt.xticks(fontsize=25)
plt.yticks(fontsize=25)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.savefig('Case5-Fig4.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(5)
plt.clf()
plt.xlabel('Time (sec)', fontsize=25)
...
plt.savefig('Case5-Fig5.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(6)
plt.clf()
plt.xlabel('Time (sec)', fontsize=25)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.savefig('Case5-Fig6.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(7)
plt.clf()
plt.xlabel('Time (sec)', fontsize=25)
...
plt.savefig('Case5-Fig7.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
plt.figure(8)
plt.clf()
plt.xlabel('Time (sec)', fontsize=25)
...
plt.savefig('Case5-Fig8.eps', format='eps', dpi=1000, bbox_inches='tight')
#--------------------------------------------------
